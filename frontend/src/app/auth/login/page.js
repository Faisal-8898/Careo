          ...
          <div className="mt-8">
            ...
            <div className="mt-8 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              ...
              <div className="text-xs text-amber-700 space-y-1">
                ...
                <div><strong>Passenger:</strong> username: john_doe, password: password123</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-full flex items-center justify-center p-12">
          <div className="max-w-md text-center text-white">
            ...
            <p className="text-lg text-primary-100 leading-relaxed">
              Experience seamless train travel with our advanced booking platform. 
              Join thousands of satisfied passengers who trust us for their journey.
            </p>
