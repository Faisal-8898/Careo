  ...
  const features = [
    {
      ...
      description:
        "Find trains and check availability in real-time across all routes.",
    },
    {
      name: "Easy Booking",
      description:
    ...
    },
    {
      name: "24/7 Service",
      description:
        "Access our platform anytime, anywhere. Customer support available 24/7.",
    },
    {
      name: "Secure Payments",
      description:
        "Multiple payment options with bank-grade security and instant confirmation.",
    },
    {
      name: "Trusted Platform",
      description:
        "Trusted by thousands of passengers with advanced audit and provenance tracking.",
    },
    {
      name: "Nationwide Coverage",
      description:
        "Covering major cities and routes across the country with extensive network.",
    },
  ];
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              ...
              <p className="mt-6 max-w-3xl mx-auto text-xl text-primary-100">
                Book train tickets easily with our advanced provenance-enabled
                management system. Fast, secure, and reliable travel planning at
                your fingertips.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-600">
                Experience the future of train travel with our comprehensive
                booking platform designed for modern travelers.
              </p>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg text-primary-100">
                  Join thousands of satisfied customers and book your next train
                  ticket today.
                </p>
