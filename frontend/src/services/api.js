...
export const routesApi = {
  ...
  removeStation: (id, stationId) => api.delete(`/routes/${id}/stations/${stationId}`),
};
...
export const reservationsApi = {
  ...
  getByBookingRef: (bookingRef) => api.get(`/reservations/booking/${bookingRef}`),
...
export const auditApi = {
  ...
  getTrainAuditById: (id) => api.get(`/audit/trains/${id}`),
  getScheduleAudit: (params = {}) => api.get('/audit/schedules', { params }),
  getScheduleAuditById: (id) => api.get(`/audit/schedules/${id}`),
  getPassengerAudit: (params = {}) => api.get('/audit/passengers', { params }),
  getPassengerAuditById: (id) => api.get(`/audit/passengers/${id}`),
  getPaymentAudit: (params = {}) => api.get('/audit/payments', { params }),
  getPaymentAuditById: (id) => api.get(`/audit/payments/${id}`),
  getAuditByUser: (userId, params = {}) => api.get(`/audit/user/${userId}`, { params }),
  getAuditByDateRange: (params) => api.get('/audit/date-range', { params }),
...
export const adminApi = {
  ...
  getTrainReports: (params = {}) => api.get('/admin/reports/trains', { params }),
};
